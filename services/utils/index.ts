...
export const CONTENT_DELIVERY_NETWORK_URI =
  process.env.CONTENT_DELIVERY_NETWORK_URI ??
  "https://static-nft.pancakeswap.com";
...
export const getCDN = (
  address: string,
  type: "avatar" | "banner-lg" | "banner-sm"
): string => {
  switch (type) {
    case "avatar":
      return `${CONTENT_DELIVERY_NETWORK_URI}/${NETWORK}/${getAddress(
        address
      )}/avatar.png`;
    case "banner-lg":
      return `${CONTENT_DELIVERY_NETWORK_URI}/${NETWORK}/${getAddress(
